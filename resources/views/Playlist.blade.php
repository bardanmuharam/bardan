...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Open+Sans:ital,wdth,wght@0,77.4,743;1,77.4,743&display=swap"
        rel="stylesheet">
</head>
...
<body>
    <header>
        <div class="jumbotron">
            <h1>PLAYLIST</h1>
            <p>Green Day telah merilis banyak lagu sepanjang karier mereka, dan banyak di antaranya masih populer hingga
    ...
    <main>
        <div id="content">
            <article id="Basket Case" class="card">
                <h2>Basket Case</h2>
                <img src="img/basketcase.jpg" alt="Basket Case" class="featured-image" />
                <audio controls>
                    <source src="songs/Basketcase.mp3" type="audio/mpeg">
                    <source src="songs/Basketcase.ogg" type="audio/ogg">
                    Your browser does not support the audio element.
                </audio>
                <p>"Basket Case" adalah salah satu lagu paling ikonik dari album ketiga Green Day, "Dookie," yang
                ...
                <p>Lirik "Basket Case" mencerminkan perasaan kecemasan dan serangan panik yang dialami Armstrong,
            ...
            <article id="American Idiot" class="card">
                <h2>American Idiot</h2>
                <img src="img/american.jpg" alt="Lagu American Idiot" class="featured-image" />
                <audio controls>
                    <source src="songs/AmericanIdiot.mp3" type="audio/mpeg">
                    <source src="songs/AmericanIdiot.ogg" type="audio/ogg">
                    Your browser does not support the audio element.
                </audio>
                <p>Lagu "American Idiot" dari Green Day, yang dirilis pada 21 September 2004, merupakan kritik tajam
                ...
                <p>"American Idiot" tidak hanya menjadi hit global, tetapi juga mempengaruhi musik punk rock dan pop
            ...
            <article id="21 Guns" class="card">
                <h2>21 Guns</h2>
                <img src="img/21guns.jpg" alt="21 Guns" class="featured-image" />
                <audio controls>
                    <source src="songs/21guns.mp3" type="audio/mpeg">
                    <source src="songs/21guns.ogg" type="audio/ogg">
                    Your browser does not support the audio element.
                </audio>
                <p>Lagu "21 Guns" dari Green Day, dirilis sebagai singel pada 16 Februari 2009 dari album 21st Century
                ...
                <p>"21 Guns" mendapat sambutan positif dari kritikus musik dan berhasil mencapai kesuksesan komersial,
